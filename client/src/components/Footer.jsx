                ...
                <div className='w-full max-w-7xl mx-auto'>
                    ...
                    <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
                        ...
                        <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left">
                            <a className='text-white text-2xl font-extrabold'>
                               ROUTECAB
                            </a>
                            ...
                            <p className='text-sm text-white/60 mt-6 max-w-sm leading-relaxed'>
                                ROUTECAB makes renting a car simple and affordable. Choose from a wide range of well-maintained vehicles — from economy cars to SUVs and luxury rides — with flexible pickup locations, transparent pricing, and 24/7 support. Book online in minutes and hit the road with confidence.
                            </p>
                        </div>
                        ...
                        <div className="w-full md:w-[45%] lg:w-[25%] flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <div className="flex items-center border gap-2 border-white/20 h-13 max-w-80 w-full rounded-full overflow-hidden mt-4">
                                ...
                                <button type="submit" className="bg-linear-to-b from-[#d83523] to-[#e25353] active:scale-95 transition w-56 h-10 rounded-full text-sm text-white cursor-pointer mr-1.5">Subscribe</button>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className='text-xs text-white/60'>© 2026 ROUTECAB</p>
